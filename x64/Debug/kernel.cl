...
kernel void writeChoices(const AytoData_t a, const uint n, global uchar* ac, global uchar* pc, local uchar* lac, local uchar* lpc, global uint* aci, glocal uint* pci, const uint workPerThread) {
